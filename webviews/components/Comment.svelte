...
<button on:click={() => sendText(copiedText, longcoment == true ? 'Long Comment' : 'Comment')}
    >Generate commented code</button
>
...
<div>
    Detailed and long comments:
    <input type="checkbox" bind:checked={longcoment} />
</div>
